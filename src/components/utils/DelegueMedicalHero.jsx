...
const trainingObjectives = [
  {
    ...
    points: [
      ...
      "Durée de la formation : 9 mois de cours intensifs suivis de 3 mois de stage ;",
      ...
      <div className="relative z-12 flex flex-col md:flex-row justify-between items-start max-w-7xl mx-auto px-6 py-12 gap-4">
        ...
        <div className="w-full md:w-1/2">
          ...
          <p className="mt-4 text-white text-sm max-w-md">
            Formez-vous au métier de Délégué Médical en 1 an à ITC Santé située
            à Yaoundé. Notre programme de formation professionnelle
            paramédicale, agréé par le MINEFOP, vous prépare à intégrer le
            secteur de la santé et de l’industrie pharmaceutique avec toutes les
            compétences nécessaires.
          </p>
          <div className="mt-6 bg-[#ffed00] border border-green-800 text-green-800 text-x px-2 py-4 rounded-xl shadow-md text-center text-base font-medium">
            <h3>Qu'est-ce qu'un Délégué Médical ? </h3>
            Le délégué médical est un acteur clé de la promotion des produits
            pharmaceutiques. Employé par un laboratoire, il a pour mission
            d’informer les professionnels de santé — médecins généralistes,
            spécialistes, pharmaciens, sage-femmes — sur les médicaments
            développés par son entreprise.
            <br />
            <button
...
export default DelegueMedicalHero;
