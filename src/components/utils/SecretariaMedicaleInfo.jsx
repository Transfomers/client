    ...
    <header className="w-full bg-white py-10 px-4 md:px-16 lg:px-24">
      <div className="relative flex flex-col md:flex-row items-start justify-between gap-6">
        ...
        <div className="relative flex-1 h-[420px]">
          <img src={process.env.PUBLIC_URL + '/asset/images/blogLingkaran.png'} alt="Secrétariat Médical" className="w-full h-full object-cover rounded-2xl" />
        ...
        <div className="relative flex-1 h-[420px] mt-10 md:mt-0 md:-translate-y-6">
          <img src={process.env.PUBLIC_URL + '/assets/myimages/sante2.jpg'} alt="Lire plus" className="w-full h-full object-cover rounded-2xl shadow-lg" />
...
export default SecreteriatMedicalInfo;
